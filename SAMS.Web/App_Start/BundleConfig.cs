...
namespace SAMS.Web
{
    public static class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(
                new StyleBundle("~/Bundles/weui/css")
                .Include("~/Content/weui/weuix.min.css")
                
                );
            bundles.Add(
                 new ScriptBundle("~/Bundles/mobile/js")
                 .Include("~/Scripts/weui/zepto.min.js")
                 .Include("~/Scripts/weui/php.js")
                 );
