...
namespace SAMS.Web.Areas.Admin.Models.Staff
{
    ...
    {
        public PagedResultDto<UserListDto>  Staffs{ get;set;}
        ...
        public int End
        {
            get
            {
                ...
                if (end > Staffs.TotalCount) end = Staffs.TotalCount;
                return end;
            }
        }
        public int PageCount {
            get
            {
                return (int)Math.Ceiling((double)Staffs.TotalCount / (double)PageSize);
            }
        }
